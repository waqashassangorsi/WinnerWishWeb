...
<nav class="standard navbar navbar-<?php echo oxy_get_option('header_type') == 'standard'? oxy_get_option('header_position'):'static' ; ?>-top <?php echo oxy_get_option('header_type')=='combo'? oxy_get_option('header_swatch'): ""; ?>">
    <div class="navbar-inner">
        ...
        -
        <span class="woocommerce-Price-amount amount "> child £ <span class="total_amount" data-total="<?php echo $single_price;?>"><?php echo number_format( $single_price,2);?></span></span>    </a></div>
                    </div>
...
<li id="menu-item-1494" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1494"><a href="#">Balance  £  <?php echo number_format($balance,2);?></a></li>
                ...
                <ul id="menu-main-header" class="nav pull-left"><li id="menu-item-1135" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1135"><a href="?page_id=1432">Competitions</a></li>
                    <li id="menu-item-1136" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1136"><a href="?page_id=1499">Winners</a></li>
					 <li id="menu-item-1136" class="menu-item visible-phone menu-item-type-custom menu-item-object-custom menu-item-1136"><a href="?page_id=1425">
        <i class="fa fa-shopping-cart"></i>
						<?php
							//sesssion_destroy();
						  //print_r($_SESSION['cart']);
