...
<div id="mini-cart-container" class="mini-cart-container <?php echo oxy_get_option( 'pageslide_cart_swatch' ); ?>">
    <a href="javascript:jQuery.pageslide.close(function(){jQuery('.mini-cart-underlay').removeClass('active');})" class="btn btn-large btn-cart-sidebar btn-icon-left swatch-pomegranate"><span><i class="fa fa-remove"></i></span> Close cart</a>
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) :
                    ...
                    <li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
        				...
        				<div class="product-details">
        				    ...
        				    <p><?php echo wc_get_formatted_cart_item_data( $cart_item ); ?></p>
    ...
    <?php if ( ! WC()->cart->is_empty() ) : ?>
    	...
    	<div class="cart-actions">
        	...
        	<div class="buttons">
        		<a href="<?php echo wc_get_cart_url(); ?>" class="btn btn-cart-sidebar btn-large btn-icon-right btn-success"><?php _e( 'View Cart', 'woocommerce' ); ?><span><i class="fa fa-shopping-cart"></i></span></a>
        		<a href="<?php echo wc_get_checkout_url(); ?>" class="btn checkout btn-cart-sidebar btn-danger btn-large btn-icon-right btn-primary"><?php _e( 'Checkout', 'woocommerce' ); ?><span><i class="fa fa-credit-card"></i></span></a>
        	</div>
        </div>
