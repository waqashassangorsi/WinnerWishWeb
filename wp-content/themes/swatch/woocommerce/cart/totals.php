		...
		<table class="table">
			<tbody>
				...
				<?php if ( $woocommerce->cart->get_discounts_before_tax() ) : ?>
					...
					<tr class="discount">
						<td><?php _e( 'Cart Discount', 'woocommerce' ); ?> <a href="<?php echo esc_url( add_query_arg( 'remove_discounts', '1', $woocommerce->cart->get_cart_url() ) ) ?>"><?php _e( '[Remove]', 'woocommerce' ); ?></a></td>
				...
				<?php if ( $woocommerce->cart->get_discounts_after_tax() ) : ?>
					...
					<tr class="discount">
						<td><?php _e( 'Order Discount', 'woocommerce' ); ?> <a href="<?php echo esc_url( add_query_arg( 'remove_discounts', '2', $woocommerce->cart->get_cart_url() ) ) ?>"><?php _e( '[Remove]', 'woocommerce' ); ?></a></td>
