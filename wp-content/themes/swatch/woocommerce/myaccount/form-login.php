...
<div class="row">
	...
	<div class="span6">
		...
		<form method="post" class="woocomerce-form woocommerce-form-login login">
			...
			<div class="woocommerce-form-row woocommerce-form-row--wide form-group form-row form-row-wide">
			...
			<p class="form-row">
				...
				<input type="submit" class="woocommerce-Button button btn btn-primary" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>" />
				&nbsp;
                <label for="rememberme" class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox inline">
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="span6" id="customer_login">
