...
class OxygennaQuickUpload
{
    ...
    public function select_images_page($post_type, $options)
    {
        ...
        if (!current_user_can('upload_files')) {
            wp_die(__('You do not have permission to upload files.', 'swatch-admin-td'));
        }
        ...
        if (isset($action) && $action == 'edit' && !$ID) {
            wp_die(__('You are not allowed to be here', 'swatch-admin-td'));
        }
        ...
        $title = __('Upload New Media', 'swatch-admin-td');
        ...
        <?php submit_button(__('Use these images', 'swatch-admin-td'), 'button savebutton', 'save'); ?>
        </form>
        </div>
...
?>
                ...
                <div id="poststuff">
                    ...
                    <div id="post-body" class="metabox-holder columns-2">
                        <div id="post-body-content">
                            ...
                            <?php submit_button(__('Save', 'swatch-admin-td') . ' ' .$options['item_plural']); ?>
                        </div>
                    </div>
                </div>
            </form>
    ...
    public function build($post_type, $options)
    {
        ...
        echo '<div id="message" class="updated fade"><p><strong>' . sprintf(__('Created %d %s', 'swatch-admin-td'), count($_POST['media_attachment_id']), $options['item_plural']) . '</strong></p></div>';
    }
}
