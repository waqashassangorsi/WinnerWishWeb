...
$shortcode_options = include_once OXY_SHORTCODE_GENERATOR_DIR . 'inc/shortcodes/shortcode-options.php';
...
$preview_url = get_site_url( $blog_id, 'wp-admin/admin-ajax.php?_ajax_nonce=' . $nonce . '&action=oxy_shortcode_preview&sc=', $scheme );
?>
